...
| it-tools | ```kubectl create deployment it-tools --image=corentinth/it-tools:latest``` <br> ```kubectl expose deployment it-tools --type=ClusterIP --port=80``` | [CorentinTh/it-tools](https://github.com/CorentinTh/it-tools) |
